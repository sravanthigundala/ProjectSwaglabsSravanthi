...
public class Manohar_03 extends BaseConfig{
		

		
		
		@Test(groups="FT",priority = 1, dependsOnMethods = "addProduct",enabled = true)
		public void updateProduct() {
			
			Reporter.log("updateProduct", true);
		}
		@Test(groups="FT",priority = 2,dependsOnMethods = "updateProduct",enabled = true)
