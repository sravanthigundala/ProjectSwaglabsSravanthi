...
public class SaiSree_10 extends BaseConfig{
	
	
	@Test(groups="IT",priority=2,dependsOnMethods ="updateproduct",enabled = true)
	public void deleteproduct() {
		Reporter.log("---deleteproduct_saisree_10---");
	
	}
	@Test(groups="IT",priority=2,dependsOnMethods ="addproduct",enabled = true)
	public void updateproduct() {
	
	Reporter.log("---update_saisree_10---");
...
//		Assert.assertTrue(shipping_continuebtn.isDisplayed()) && shipping_continuebtn.isEnabled());
		...
		WebElement shipmethod_continuebtn = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@onclick='ShippingMethod.save()']")));
...
//		Assert.assertTrue(paymentinfo_continuebtn.isDisplayed() && paymentinfo_continuebtn.isEnabled());
	...
	//	Assert.assertTrue(confirm_btn.isDisplayed() && confirm_btn.isEnabled());
		...
		Assert.assertTrue(continue_btn.isDisplayed() && continue_btn.isEnabled());
