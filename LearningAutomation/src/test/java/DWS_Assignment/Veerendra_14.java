...
public class Veerendra_14 extends BaseConfig {
		

		
		@Test(groups="IT",priority = 1, dependsOnMethods = "addProduct",enabled = true)
		...
		@Test(groups="IT",priority = 1, enabled = true)
		public void addProduct() {
			...
			WebElement addtocart_btn = driver.findElement(By.xpath("//input[@id='add-to-cart-button-72']"));
